...
export const FAQ = () => {
	...
	const questionStyle = 'text-smallest md:text-3xl md:leading-relaxed semi-bold cursor-pointer mt-4';
	const answerStyle =
	...
	return (
		<div className='px-12 pt-4 md:p-8'>
			<div className='max-w-4xl mx-auto text-white'>
				<h2 className='text-xl md:text-5xl mt-2 mb-10 md:mt-6 md:mb-16'>Frequently Asked Questions</h2>
					...
					{faqs.map((faq, index) => (
						<div key={index}>
							<h3
								...
								{faq.question}
								{activeIndex === index ? <FiMinus className='transition-transform' /> : <FiPlus className='transition-transform' />}
							</h3>
							<div className={`${answerStyle} ${activeIndex === index ? 'h-auto' : 'h-0'}`}>
